...
class ApiModel(object):
    ...
    def item_list_response_format(self):
        return  self.api.model('List of Items', {
                                    "items": fields.List(fields.Nested(self.item_format()))
                                        })
    ...
    def location_creation_format(self):
        return self.api.model("Location Creation", {
                                "user_id":fields.Integer(description="Id of user",required=True),
                                "street":fields.String(description="Address of User", required=True),
                                "apt":fields.String(description="Address of User", required=False),
    ...
    def location_radius_response_format(self):
        return self.api.model("Locations within give radius from source", {
                                "user_id":fields.Integer(description="Id of user",required=True),
                                "street":fields.String(description="Address of User", required=True),
                                "apt":fields.String(description="Address of User", required=False),
                                "city":fields.String(description="City of User", required=True),
                                "state":fields.String(description="State of User", required=True),
                                "zip":fields.String(description="Zip Code of User", required=True),
                                "distance":fields.Integer(description="distance from source address",required=True)
                            })
    def location_radius_response_list(self):
        return self.api.model("List of destinations and distance within specified radius",{
                                "locations":fields.List(fields.Nested(self.location_radius_response_format()))
                                })
    ...
    def search_item_response_model(self):
        return self.api.model("Search Item Model",{
                                "items":fields.List(fields.Nested(self.item_list_response_format())),
                                })
